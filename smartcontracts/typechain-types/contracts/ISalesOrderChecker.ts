...
export interface ISalesOrderCheckerInterface extends utils.Interface {
  functions: {
...
export interface ISalesOrderChecker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISalesOrderCheckerInterface;
